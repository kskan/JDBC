        ...
        <header>
            <div class="container">
                <% if (null != request.getSession().getAttribute("user")) {%>
                    <nav>
                        <a href="<%=request.getContextPath()%>/message/list.do">返回留言板主页</a>
                    </nav>
                    <nav>
            ...
            <div class="container">
                <c:forEach items="${messages}" var="msg">
                    <div class="alt-item">
                        ...
                        <a href="<%=request.getContextPath()%>/reMyMessagePrompt.do?messageid=${msg.id}"><button>修改</button></a>
                        <a href="<%=request.getContextPath()%>/delMyMessagePrompt.do?messageid=${msg.id}"><button>删除</button></a>
                    </div>
                </c:forEach>
            </div>
        </section>
